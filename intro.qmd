...
Since LASSO can shrink some of the coefficients to zero this method provides for an automated way for doing model selection in linear regression. ([@Hastie15])
